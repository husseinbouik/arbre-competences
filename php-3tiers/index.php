...
if($deleteResult > 0){
    ...
    if ($studentBllObj->errorMesssage !='') {
...
<tr>
    ...
    <td class="center"><a href="edit.php?id=<?php echo $student->GetId() ?>">Edit</td>
    <td class="center"><a onclick="return confirm('Do you really want to delete this record?')"  href="index.php?id=<?php echo $student->GetId() ?>&delete=yes">Delete</td>
    </tr>
